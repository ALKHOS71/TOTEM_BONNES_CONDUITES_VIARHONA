...
map.getView().fit([526707.500306, 5700895.355283, 697675.314922, 5820235.379095], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">TOTEM DE BONNES CONDUITES</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_TOTEMSBONNECONDUITE_4,
    colName: 'Identifian',
    zoom: 10,
    collapsed: true,
    map: map,
